...
use crate::metadata::{self, CommodityVaultNFTMetadata};

#[contract]
pub struct CommodityVaultNFT;

#[contractimpl]
impl CommodityVaultNFT {
    pub fn initialize(
        env: Env,
        asset_id: BytesN<32>,
        country_code: String,
    ...
    pub fn mint(env: Env, to: Address, meta: CommodityVaultNFTMetadata) -> u64 {
    ...
    pub fn update_metadata(env: Env, token_id: u64, meta: CommodityVaultNFTMetadata) {
